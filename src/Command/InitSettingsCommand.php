...
class InitSettingsCommand extends Command
{
    private const DEFAULT_SETTINGS = [
        ...
        ['key' => 'premium_webhook_gate_enabled', 'value' => '1', 'type' => 'boolean', 'label' => 'Bloquer Webhook Embed sans premium', 'description' => 'Si desactive, l\'editeur d\'embed webhook est gratuit pour tous', 'category' => 'premium', 'position' => 32],
        ['key' => 'premium_webhook_payment_type', 'value' => 'one_time', 'type' => 'text', 'label' => 'Type de paiement Webhook Embed', 'description' => 'Mode de facturation : one_time (paiement unique) ou monthly (abonnement mensuel)', 'category' => 'premium', 'position' => 33],
        ['key' => 'premium_webhook_cost', 'value' => '75', 'type' => 'number', 'label' => 'Cout Webhook Embed (NexBits)', 'description' => 'Nombre de NexBits pour debloquer/renouveler l\'editeur d\'embed webhook', 'category' => 'premium', 'position' => 34],
