...
#[ORM\Entity(repositoryClass: TwitchSubscriptionRepository::class)]
#[ORM\Table(name: 'twitch_subscription')]
#[ORM\UniqueConstraint(name: 'uniq_twitch_sub_server', columns: ['server_id'])]
