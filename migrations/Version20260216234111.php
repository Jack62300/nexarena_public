...
final class Version20260216234111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD bio LONGTEXT DEFAULT NULL, ADD discord_username VARCHAR(100) DEFAULT NULL, ADD steam_username VARCHAR(100) DEFAULT NULL, ADD twitch_username VARCHAR(100) DEFAULT NULL, ADD game_usernames JSON DEFAULT NULL, ADD profile_visibility JSON NOT NULL DEFAULT (\'{"email":false,"discord":false,"steam":false,"twitch":false,"games":false,"servers":true}\')');
    }
